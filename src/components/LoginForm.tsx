...
import React, { ChangeEvent, Dispatch, FC, SetStateAction, memo, useCallback } from 'react'
...
const LoginForm: FC<userLoginProps> = memo(({ user, setUser, onLogin, buttonDisabled, setLoginAs }) => {
    ...
    return (
        <div className="bg-white px-8 py-12 rounded-3xl border-2 border-gray-200 w-full max-w-md relative">
            ...
            <p className="font-medium text-sm text-gray-500 mt-3 text-center">welcome to the Login Page</p>
            <div className="mt-6">
                <div>
            ...
            <div className="mt-6 flex flex-col gap-y-3">
                ...
                <h3 className="mt-1 text-gray-700 text-center text-xs font-medium active:scale-[.98] active:duration-75 transition-all">{"Don't have an account? "}<Link href='/signup' className="text-violet-500 font-semibold hover:text-pink-400">Sign up</Link></h3>
            </div>
